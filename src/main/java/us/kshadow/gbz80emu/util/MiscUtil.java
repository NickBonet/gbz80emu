...
/**
 * Any misc. utility methods that don't really fall into scope anywhere else in the project go here.
...
public class MiscUtil {
    ...
    /**
     * Handles resizing a BufferedImage, mostly used for upscaling the frames a bit in the emulator.
